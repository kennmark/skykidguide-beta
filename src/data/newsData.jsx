export const newsData = [
  {
    id: 1,
    newsTitle: '@SKYKIDTulongGabay - Youtube Channel',
    newsBody: ` Please like and subscribe ang youtube channel. Ito ay malaking
            tulong na po sa amin. I-click`,
    newsLink: 'https://www.youtube.com/@SKYKIDTulongGabay',
  },
  {
    id: 2,
    newsTitle: `New Feature: Difficulty Bar on Spirit's Info.`,
  ...
  {
    id: 4,
    newsTitle: `Season 21 - Season of Nesting!`,
    newsBody: `Starting Next week, April 15, 2024 until June 30, 2024,  Sky’s 
    latest Season continues Aviary Village’s expansion, putting Sky children 
    front and center with a new location ready to be made into something truly 
  ...
  {
    id: 5,
    newsTitle: `Special Event: Sky × Cinnamoroll Pop-Up Cafe`,
    newsBody: `A village isn’t complete without a cafe, and it’s 
    finally time to open one in Sky. From 00:00 April 27th through 23:59 
    May 17th, join us for a collaboration event for the grand opening of
     Aviary Village’s new cafe, featuring the beloved Sanrio character 
     Cinnamoroll! This shy but friendly pooch knows a thing or two about 
