...
export const maps = [
  ...
  // {
  //   id: 1,
  //   title: 'Season of The Two Embers I',
  //   subtitle: 'Featured Season',
  //   alt: SEASON_ALT,
  //   img: GIF_SEASON,
  //   group: 'map-9 shadow-8',
  //   pageRoute: 'seasons/2025/season-26/two-embers-one',
  //   caption: 'The heart and history of Sky: A New Season in Sky',
  //   num_of_wls: S25_NUM_WL,
  //   num_of_reg_spirits: S25_NUM_REG_SPIRIT,
  //   num_of_season_spirits: S25_NUM_SEASON_SPIRIT,
  //   num_of_map_shrines: S25_NUM_MAP_SHRINES,
  // },
  {
    id: 2,
    title: 'Isle Of Dawn',
