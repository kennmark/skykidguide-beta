...
export const maps = [
  {
    ...
    subtitle: '8th Map',
    map_intro: 'The New Homespace',
    alt: AVIARY_ALT,
    img: GIF_AVIARY,
    group: 'map-8 shadow-8',
    pageRoute: 'maps/8/aviary-village',
    caption: 'The forgotten part of the Sky kingdom is returning',
    num_of_wls: AVIARY_NUM_WL,
    num_of_season_spirits: AVIARY_NUM_SEASON_SPIRIT,
    num_of_reg_spirits: AVIARY_NUM_REG_SPIRIT,
    num_of_map_shrines: AVIARY_NUM_MAP_SHRINES,
  },
  {
    id: 1,
    ...
    pageRoute: 'seasons/2026/season-29/carnival',
    caption: 'The Season of Carnival',
    num_of_wls: S29_NUM_WL,
    num_of_reg_spirits: S29_NUM_REG_SPIRIT,
    num_of_season_spirits: S29_NUM_SEASON_SPIRIT,
    num_of_map_shrines: S29_NUM_MAP_SHRINES,
  },
  {
    id: 2,
    title: 'Isle Of Dawn',
    ...
    caption: 'This is where your journey begins, enjoy the view and the music!',
  ...
  },
  {
    ...
    caption: 'Enjoy the beauty of the Daylight Prairie!',
  ...
  },
  {
    ...
    caption: 'Dont stay too long in the rain and waters.',
  ...
  },
  {
    ...
    caption: 'Train your reflexes and be ready to run, jump, and slide through the valley two races.',
  ...
  },
  {
    ...
    caption: 'Krills are waiting to ambush you, be careful and keep your light safe',
  ...
  },
  {
    ...
    caption: 'Kindness is the key to open the vault.',
  ...
  },
  {
    ...
    caption: 'Be Ready to face the darkness and the unknown!',
    map: 'Eye of Eden',
