import {
  ...
  S19_NUM_REG_SPIRIT,
  S19_NUM_SEASON_SPIRIT,
  S19_NUM_WL,
  S19_NUM_MAP_SHRINES,
  S20_NUM_REG_SPIRIT,
  S20_NUM_SEASON_SPIRIT,
  S20_NUM_WL,
  S20_NUM_MAP_SHRINES,
...
export const maps = [
  ...
  // {
  //   id: 9,
  //   title: 'Season of The Nine Colored Deer',
  //   subtitle: 'Featured Season',
  //   alt: SEASON_ALT,
  //   img: GIF_SEASON,
  //   group: 'map-9 shadow-8',
  //   pageRoute: 'seasons/2024/season-20/the-nine-colored-deer',
  //   caption: 'Nine Colored Deer',
  //   num_of_wls: S20_NUM_WL,
  //   num_of_reg_spirits: S20_NUM_REG_SPIRIT,
  //   num_of_season_spirits: S20_NUM_SEASON_SPIRIT,
  //   num_of_map_shrines: S20_NUM_MAP_SHRINES,
  // },
]
