    ...
    <div className="flex justify-center">
      ...
      <div className="justify-start w-full">
        <PageHeaderContainer
          ...
          width={75}
          title={name}
          mapIntro={'The stars have aligned to welcome a royal visitor'}
        />
            ...
            <TabPanel key={activeTab} value={activeTab}>
              {activeTab === 'info' && (
                <div className="text-gray-100 pb-5">
                  ...
                  <br />
                  <Typography>
                    Ang Starlight Dessert ay makikita sa Vault of Knowledge,
                    ika-anim na mapa. Pagkapasok sa mapa, sa kaliwang parte sa
...
export default S10TheLittlePrincePage
