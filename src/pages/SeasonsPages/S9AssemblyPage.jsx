    ...
    <div className="flex justify-center">
      ...
      <div className="justify-start w-full">
        <PageHeaderContainer
          ...
          width={75}
          title={name}
          mapIntro={'Be prepared to pledge allegiance as a Scout'}
        />
            ...
            <TabPanel key={activeTab} value={activeTab}>
              {activeTab === 'info' && (
                <div className="text-gray-100 pb-5">
                  ...
                  <br />
                  <Typography>
                    Ang Treehouse ay makikita sa Hidden Forest, ikatlong mapa.
                    Pagkapasok sa mapa ay lumipad pababa sa mga kaulapan. Bago
                    makarating sa Forest Clearing - Entrance, ay may lagusan sa
