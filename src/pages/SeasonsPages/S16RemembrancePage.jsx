    ...
    <div className="flex justify-center">
      ...
      <div className="justify-start w-full">
        <PageHeaderContainer
          ...
          width={75}
          title={name}
          mapIntro={'Where the past meets the present'}
        />
            ...
            <TabPanel key={activeTab} value={activeTab}>
              {activeTab === 'info' && (
                <div className="text-gray-100 pb-5">
                  ...
                  <br />
                  <Typography>
                    Ang Repository Refuge ay mahahanap sa first floor ng Vault
                    of Knowledge. Pagkapasok sa mapang ito, dumako sa raising
...
export default S16RemembrancePage
