    ...
    <div className="flex justify-center">
      ...
      <div className="justify-start w-full">
        <PageHeaderContainer
          ...
          width={75}
          title={name}
          mapIntro={'It takes a village to reach a dream'}
        />
            ...
            <TabPanel key={activeTab} value={activeTab}>
              {activeTab === 'info' && (
                <div className="text-gray-100 pb-5">
                  ...
                  <br />
                  <Typography>
                    Ang Village of Dreams ay makikita sa Valley of Triumph.
                    Pagkapasok sa mapa, ay nasa kanang bahagi ay may lagusan
                    papasok papuntang village of dreams.
                  </Typography>
                </div>
              )}
