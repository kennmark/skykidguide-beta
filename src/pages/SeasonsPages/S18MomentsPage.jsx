            ...
            <TabPanel key={activeTab} value={activeTab}>
              {activeTab === 'info' && (
                <div className="text-gray-100 pb-5">
                  ...
                  <br />
                  <Typography>
                    Ang Prairie Peaks ng Season of Moments ay makikita sa
                    Daylight Prairie, pangalawang mapa. Pagkapasok dito ay
