            ...
            <TabPanel key={activeTab} value={activeTab}>
              {activeTab === 'info' && (
                <div className="text-gray-100 pb-5">
                  ...
                  <br />
                  <Typography>
                    Ang Prophecy Cave ay makikita sa Isle of Dawn, sa unang
                    mapa. Pumasok ka at magtungo sa kweba hanggang makalabas ka.
